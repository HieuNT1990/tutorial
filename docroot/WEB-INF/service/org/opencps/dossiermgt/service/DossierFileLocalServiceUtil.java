...
public class DossierFileLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<org.opencps.dossiermgt.model.DossierFile> getDossierFileByDossierAndDossierPart(
		long dossierId, long dossierPartId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getDossierFileByDossierAndDossierPart(dossierId,
			dossierPartId);
	}
